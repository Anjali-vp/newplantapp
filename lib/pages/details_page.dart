                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          IconButton(onPressed: (){}, icon: Icon(Icons.sunny,color: Colors.black,size: 20,)),
                          IconButton(onPressed: (){}, icon: Icon(Icons.water_drop_outlined,color: Colors.black,size: 20,)),
                          IconButton(onPressed: (){}, icon: Icon(Icons.thermostat,color: Colors.black,size: 20,)),
                          IconButton(onPressed: (){}, icon: Icon(Icons.arrow_circle_up_outlined,color: Colors.black,size: 20,))
